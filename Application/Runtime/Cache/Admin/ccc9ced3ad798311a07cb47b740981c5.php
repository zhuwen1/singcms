          ...
          <div class="table-responsive">
            <form id="singcms-listorder">
              ...
              <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$new): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                      <?php echo (isThumb($new["thmub"])); ?>
                    </td>
                    <td><?php echo (date('Y-m-d H:i',$new["create_time"])); ?></td>
                  <td><span  attr-status="<?php echo ($new["status"]); ?>"  attr-id="<?php echo ($new["news_id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off" ><?php echo (status($new["status"])); ?></span></td>
